...
#experiments for seqalt distributed ts hardware stack
...
for i in $(seq $count); do
    ./seqalt-sc-distributed-stack-ts-hardware-stack -threads=$1 -threshold=$2 -elements=$3 >> ./output/seqalt-distributed-ts-hardware-stack$4 ;
done
