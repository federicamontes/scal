...
#experiments for prodcon distributed treiber stack
...
for i in $(seq $count); do
    ./prodcon-sc-distributed-stack-treiber -producers=$1 -consumers=$2 -threshold=$3 -operations=$4 >> ./output/output-prodcon-distributed-treiber ;
done
